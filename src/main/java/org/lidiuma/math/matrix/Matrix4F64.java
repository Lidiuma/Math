...
public value record Matrix4F64(
    ...
    public static Matrix4F64 fromTR(Vector3F64 translation, QuatF32 rotation) {
    ...
    public static Matrix4F64 fromAxisAngle(Vector3F64 axis, Radians angle) {
        ...
        final var quat = QuatF32.fromAxisAngle(axis, angle);
        return fromRotation(quat);
    }

    /// @return a pure rotation matrix from the quaternion.
    public static Matrix4F64 fromRotation(QuatF32 quaternion) {
    ...
    public static Matrix4F64 fromRotationBetween(Vector3F64 v1, Vector3F64 v2) {
        final var quat = QuatF32.fromRotationBetween(v1, v2);
        return fromRotation(quat);
    }
    ...
    /// @return The transformation matrix.
    /// @apiNote The rotation quaternion is normalized internally.
    public static Matrix4F64 fromTRS(Vector3F64 translation, QuatF32 rotation, Vector3F64 scale) {
    ...
    public Matrix4F64 average(Matrix4F64 other, Double weight) {
        ...
        final QuatF32 rotation = rotation().slerp(other.rotation(), otherWeight);
    ...
    @Override
    public QuatF32 rotation() {
        return QuatF32.fromMatrix4(this);
    }
    ...
    @Override
    public Matrix4F64 rotate(QuatF32 rotation) {
