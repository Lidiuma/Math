...
public record Integer1(
        @Override Integer x
) implements UnaryTuple1<Integer> {

    public Integer1(UnaryTuple1<Integer> tuple) {
        this(tuple.x());
    }

    public Integer1(UnaryTuple2<Integer> tuple) {
        this(tuple.x());
    }

    public Integer1(UnaryTuple3<Integer> tuple) {
        this(tuple.x());
    }

    public Integer1(UnaryTuple4<Integer> tuple) {
        this(tuple.x());
    }
}
