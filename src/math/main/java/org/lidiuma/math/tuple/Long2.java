...
) implements UnaryTuple2<Long> {

    public Long2(UnaryTuple1<Long> tuple, long y) {
        this(tuple.x(), y);
    }

    public Long2(UnaryTuple2<Long> tuple) {
        this(tuple.x(), tuple.y());
    }

    public Long2(UnaryTuple3<Long> tuple) {
        this(tuple.x(), tuple.y());
    }

    public Long2(UnaryTuple4<Long> tuple) {
        this(tuple.x(), tuple.y());
    }
}
