...
public value record Long3(
    ...
    public Long3(UnaryTuple1<Long> tuple, long y, long z) {
        this(tuple.x(), y, z);
    }

    public Long3(UnaryTuple2<Long> tuple, long z) {
        this(tuple.x(), tuple.y(), z);
    }

    public Long3(UnaryTuple3<Long> tuple) {
        this(tuple.x(), tuple.y(), tuple.z());
    }

    public Long3(UnaryTuple4<Long> tuple) {
        this(tuple.x(), tuple.y(), tuple.z());
    }
}
