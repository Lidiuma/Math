...
@FactoryAlias(methodName = ANGLE_FACTORY + F64, outputClass = ROTATION_OUT)
@LooselyConsistentValue
public value record AngleF64(@Override @NullRestricted Double radian) implements Angle<Double> {
